...
{
\noindent
\begin{minipage}{0.45\textwidth} % Adjust the width to fit your document
    \noindent
...
of the proof.
\end{minipage}%
\hfill % Optional space between the text and figure
%\begin{minipage}{0.45\textwidth}
%    \centering
%    \label{fig:schematic_roots}
%        \includegraphics[width=0.75\textwidth]{d_triangular.jpeg}
%        \captionof{figure}{
%            Schematic of root finding steps using Sperner's lemma. 
%            Orange line is a path narrowing root region of the given function, $f$. 
%            The circle is a disk $D$ on complex plane.
%        }        
%\end{minipage}
}
